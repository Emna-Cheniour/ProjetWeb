...
<head>
    ...
    <title>Don</title>
    <link href="assets/css/don.css" rel="stylesheet">
...
<div class="contenu">
    ...
    <div class="introDon">
        ...
        <form class="formDon">
            ...
            <div class="titleForm"><img id="imageDonate" src="icons/donate.png">
            Faire un Don</div>
            </br>
        <table class="Form">
            <tr>
        ...
        <button type="submit" id="submitForm" class="btn btn-primary btn-lg" name="submitForm">Faire un Don</button>
        </form>
        </div>
        </div>
        ...
        <form class="formPay">
            ...
            <span><button type="button" class="btn btn-primary btn-lg" name="revenirCat">Revenier au catalogue</button>
            <button type="submit" class="btn btn-primary btn-lg" name="submitPay">Payer maintenant</button></span>
        </form>
        </div>
    </div>
